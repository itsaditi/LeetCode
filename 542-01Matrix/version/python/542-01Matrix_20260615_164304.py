# Last updated: 6/15/2026, 4:43:04 PM
...
25
26            for direction in self.DIRECTIONS:
27                adj_row = row + direction[0]
28                adj_col = col + direction[1]
29                
30                if (adj_row < 0 or adj_row >= self.TOTAL_ROW) or (adj_col < 0 or adj_col >= self.TOTAL_COL):
31                    continue
32                
33                if visited[adj_row][adj_col]:
34                    continue
35
36                visited[adj_row][adj_col] = True
37                queue.append([adj_row, adj_col, dist + 1])
38                matrix[adj_row][adj_col] = dist + 1
39    
40        return matrix
41        
42
